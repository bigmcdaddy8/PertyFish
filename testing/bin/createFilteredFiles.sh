...
# cat ${D1}/${F0} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F0}
cat ${D1}/${F1} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F1}
cat ${D1}/${F2} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F2}
cat ${D1}/${F3} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F3}
cat ${D1}/${F4} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F4}
cat ${D1}/${F5} | tr -d '\0' | grep -v '^ *#' | grep -v '^$' | cut -d';' -f1 | awk '{ gsub(/ +/, " "); print $0 }' > /tmp/filtered01.${F5}
