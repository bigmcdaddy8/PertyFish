...
- Under the git setting within your new blank application click on the "Git version control" and click the "Connect" button to create a connection to your forked repository. Fill out and complete connection details when prompted.
...
- Great article [Peter Ellis Jones](https://peterellisjones.com/posts/generating-legal-chess-moves-efficiently/)
